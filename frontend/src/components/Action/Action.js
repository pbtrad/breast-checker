...
function Action() {
    return (
        <div className="container">
                ...
                <h1 className="text-center my-5">Further Action</h1>
                ...
                <p className="text-center my-5">Please find links to external resources below for more information about breast cancer.
                </p>

                {/* Links to external resources */}
                <div className="container px-4 py-5" id="featured-3">
                <h2 className="pb-2 border-bottom text-center">External Links</h2>
                {/* Links to external healthcare advice */}
                <h3 className="text-center text-decoration-underline p-5 pb-2">Heathcare Advice</h3>
                <div className="row g-4 py-5 row-cols-1 row-cols-lg-3">
                    <div className="feature col">
                    <div className="feature-icon">
                        <img src="./assets/images/american-cancer-society-logo-small.png" alt="Image of the American Cancer Society Logo"
                        aria-hidden="true" />
                    </div>
                    ...
                    <a href="https://www.cancer.org/cancer/breast-cancer.html" target="_blank" rel="noopener noreferrer"
                        ...
                        Link to website <i className="fas fa-external-link-alt"></i>
                    </a>
                    </div>
                    <div className="feature col">
                    <div className="feature-icon">
                        <img src="./assets/images/nhs-logo-small.png" alt="Image of the UK's Health Service (the NHS) Logo" aria-hidden="true" />
                    </div>
                    <h2>NHS UK</h2>
                    ...
                    <div className="feature col ">
                    <div className="feature-icon">
                        <img src="./assets/images/hse-logo-small.png" alt="Image of Ireland's Health Service (the HSE) Logo" aria-hidden="true" />
                    </div>
                    <h2>HSE Ireland</h2>
                ...
                <h3 className="text-center text-decoration-underline pb-2">Charities</h3>
                <div className="row g-4 py-5 row-cols-1 row-cols-lg-3">
                    <div className="feature col">
